  ...
  <div class="page-content">
    ...
    <div class="content-wrapper">
      <!-- Content area -->
        ...
        <!-- Login form -->
        <form class="login-form form-horizontal cmxform" method="post" id="commentForm" action="{BASE_URL}pages/content/user/action/add" enctype="multipart/form-data">
          <div class="card mb-0">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <input type="text" class="form-control" name="fullname" id="fullname" placeholder="Nama" maxlength="100" onkeypress="return string(event)" required>
              </div>

              <!-- <div class="form-group">
                <select class="form-control select2" data-placeholder="Jenis Kelamin" name="jenis_kelamin" id="jenis_kelamin" required>
                  <option value="">Select ...</option>
                  <?php
                    /* $select = array('Laki-laki','Perempuan');
                    foreach($select as $i => $r){
              ...
              <!-- <div class="form-group">
                <input type="email" class="form-control" name="email" id="email" placeholder="Email" onkeypress="return string(event)" required>
              </div> -->

              <div class="form-group">
                <input type="text" class="form-control" name="address" id="address" maxlength="200" value="" placeholder="Address" onkeypress="return string(event)" required>
              </div>

              <div class="form-group">
                <input type="text" class="form-control" name="phone" id="phone" maxlength="13" value="" placeholder="Phone" onkeypress="return number(event)" required>
              </div>
              ...
              <div class="form-group form-group-feedback form-group-feedback-left">
                <input type="password" class="form-control" name="password" id="password" placeholder="Password" maxlength="20" onkeypress="return string(event)" required>
                <div class="form-control-feedback">

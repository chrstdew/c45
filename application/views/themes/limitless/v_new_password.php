  ...
  <div class="page-content">
    ...
    <div class="content-wrapper">
      <!-- Content area -->
        ...
        <!-- Login form -->
        <form class="login-form form-horizontal cmxform" method="post" id="commentForm" action="{BASE_URL}pages/new_password">
          <div class="card mb-0">
            ...
            <div class="card-body">
              <div class="text-center mb-3">
                ...
                <span class="d-block text-muted">New Password</span>
              </div>
              ...
              <input type="hidden" class="form-control" name="id_user" id="id_user" value="{id_user}" required>
              <?php
              ...
              <br>
              <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block" name="btnLogin" value="login"> New Password </button> <br>

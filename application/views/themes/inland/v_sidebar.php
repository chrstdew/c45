...
echo '
<div class="int_infosidebar" style="background-color: #040459;">
    <div class="siderbar_social">
        <ul>
            <li><a href="https://facebook.com/'.$info['facebook'].'" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
            <li><a href="https://facebook.com/'.$info['instagram'].'" target="_blank"><i class="fab fa-instagram"></i></a></li>
        </ul>
    </div>

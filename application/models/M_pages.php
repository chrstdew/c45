...
class M_pages extends CI_Model {
	...
	public function menu_navigation(){
		...
		$public_menu = array(
			...
			// array('pages'=>$content_url.'solution','class'=>'table','name'=>'Our Solution'),
			// array('pages'=>$content_url.'team','class'=>'users','name'=>'Our Team'),
			// array('pages'=>$content_url.'client','class'=>'building','name'=>'Our Client'),
			// array('pages'=>$content_url.'partner','class'=>'handshake','name'=>'Partnership'),
			array('pages'=>$content_url.'about','class'=>'info','name'=>'About'),
			// array('pages'=>$content_url.'contact','class'=>'envelope','name'=>'Contact'),
		);
		...
		if($this->sLogin==TRUE){
			...
			if(in_array($this->sLevel,array('1'))){
				if($this->sPublic==TRUE){
					$menu = $public_menu;
				}
				else{
					$menu = array(
						//array('pages'=>base_url().'pages/session','class'=>'eye','name'=>'Public Web'),
						array('pages'=>$content_url.'user/data','class'=>'user','name'=>'User'),
						array('pages'=>$content_url.'pegawai/data','class'=>'male','name'=>'Pegawai'),
						...
						array('pages'=>$content_url.'c45/data','class'=>'gear','name'=>'C45'),
						// array('pages'=>$content_url.'info/data','class'=>'info','name'=>'Info'),
						// array('pages'=>$content_url.'report/data','class'=>'file-pdf-o','name'=>'Report'),
					);
				}
			}
			elseif(in_array($this->sLevel,array('2','3'))){
				if($this->sPublic==TRUE){
					$menu = $public_menu;
				}
				else{
					$menu = array(
						/* array('class'=>'table','name'=>'Data Master',
							'sub'=>array(
								array('pages'=>$content_url.'user/data','class'=>'user','name'=>'User'),
								)
						), */

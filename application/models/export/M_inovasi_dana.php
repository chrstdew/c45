...
class M_inovasi_dana extends CI_Model {
	...
	public function index(){
		...
		$data['file_name'] = 'Pendanaan_Inovasi_Internal';
	...
	public function start(){
		...
		if(isset($_POST['date1']) && isset($_POST['date2'])){
			...
			$condition .= " AND tanggalk BETWEEN '$data[date1]' AND '$data[date2]'";
		}
		...
		$data['fn'] = array('Tanggal','Nama Ketua','Prodi','Judul Penelitian','Jumlah Hibah');

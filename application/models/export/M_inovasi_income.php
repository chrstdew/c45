...
class M_inovasi_income extends CI_Model {
	...
	public function start(){
		...
		$data['table'] = "inovasi_income";
		$data['field'] = "
		tanggal_mou,
		masa_berlaku,
		nama_perusahaan,
		nama_pemilik,
		deskripsi_produk_inovasi,
		tgl_invoice";
		$data['condition'] = "WHERE flag_aktif='1' AND tanggal_mou BETWEEN '$data[date1]' AND '$data[date2]' ORDER BY created DESC";
		$data['fn'] = array('Tgl MOU','Masa Berlaku','Nama Perusahaan','Nama Pemilik','Deskripsi Produk Inovasi','Tgl Invoice');
		$data['width'] = array('5%','12%','20%','15%','15%','21%', '12%');
		$data['start'] = 0;

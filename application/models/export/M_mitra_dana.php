...
class M_mitra_dana extends CI_Model {
	...
	public function index(){
		...
		$data['file_name'] = 'Sumber Pendanaan';
	...
	public function start(){
		...
		$data['fn'] = array('Tgl MOU','Masa Berlaku','Nota Kesepahaman','Instansi','Kategori Dikti','Lingkup Pendanaan');
		$data['width'] = array('5%','12%','20%','18%','20%','10%','15%');
		$data['start'] = 0;
